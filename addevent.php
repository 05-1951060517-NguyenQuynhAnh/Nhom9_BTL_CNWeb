                    ...
                    <div class="col-md ">
                        <div id="first">
                            <div class="myform form">
                                <form class="form-signin" width="100" action="process_addevent.php" method="post">
                                    ...
                                    <input type="text" id="txtName" name="txtName" class="form-control" placeholder=""
                                        required autofocus>
                                    <label for="txtTime" class="sr-only">Time</label>
                                    <input type="text" id="txtTime" name="txtTime" class="form-control"
                                        placeholder="" required autofocus>
                                    <label for="txtContent" class="sr-only">Content
                                    </label>
                                    <input type="text" id="txtContent" class="form-control" name="txtContent">
                                    <label for="txtLocation" class="sr-only">Location</label>
                                    <input type="text" id="txtLocation" name="txtLocation" class="form-control"
                                        placeholder="" required autofocus>
                                    
                                    <label for="txtAtten" class="sr-only">Attendees</label>
                                    <input type="text" id="txtAtten" name="txtAtten" class="form-control"
                                        placeholder="" required autofocus>
                                    <label for="txtImg_gr" class="sr-only">Image</label>
                                    <input type="text" id="txtImg_gr" name="txtImg_gr" class="form-control"
                                        placeholder="" required autofocus>
