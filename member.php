...
<head>
    ...
    <title><?php echo $row['name']; ?> | Meetup</title>
        ...
        <div class="header container-fluid mt-1">
            ...
            <form class="form_search" action="find.php" method="post">
                <div class="d-flex">
                    ...
                    <button style="height: 42px;border-radius: 0px 8px 8px 0px;background: #f65858;padding:0px 13px;"class="border-0 ">  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <div class="container">
        ...
        <div class=" row">
            ...
            <div class="col-md-6 p-0">
                <img style="border-radius: 200px; margin-left:280px; height: 352px;width: 352px;" class="mt-4"
                    src="image/<?php echo $row['avatar']?>" alt="">
            </div>
            <div class="col-md-6 p-0">
