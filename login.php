...
<head>
    ...
    <title>Login to Meetup | Meetup</title>
                            ...
                            <div class="myform form">
                                <form class="form-signin" width="100" action="process_login.php" method="post">
                                    <div class="text-center">
                                        <img class="mb-3" src="images/logo2.png" alt="" width="52" height="52">
                                        <h5 class="fw-bold h3 mb-3 mt-0 font-weight-normal">
                                            Log in
                                        </h5>
                                        <a>Not a member yet?</a> <a class="text-decoration-none" href="signup.php">Sign
                                            up</a>
                                    </div>
                                    <label for="inputEmail" class="sr-only">Email
                                    </label>
                                    <input type="email" id="inputEmail" class="form-control" name="txtEmail" required
                                        autofocus>
