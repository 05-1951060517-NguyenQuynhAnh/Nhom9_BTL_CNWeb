            ...
            <div class="h-right collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ">
                    <li class="nav-item me-4">
                        <a href="" class="text-muted text-decoration-none"><span>Explore</span></a>

                    </li>
                    <li class="nav-item me-4">
                        <a href="" class="text-muted text-decoration-none"><span>
                                Messages
                            </span></a>
                    </li>
                    <li class="nav-item me-4">
                    ...
                    <li class="nav-item me-3">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" style="font-size:13px;letter-spacing: 0.65px;">
                                ...
                                <li><button class="text-muted dropdown-item" type="button">View profile</button></li>
