...
<div id="header">
    ...
    <div class="h-search">
        <form action="">
            ...
            <button class="btnsearch_header " style="background-color: #f77077;width: 80px; border-radius: 2px;">
                <svg xmlns="http://www.w3.org/2000/svg"  width="18" height="18" fill="currentColor" class="bi bi-search link-light" viewBox="0 0 16 16">
    ...
    <div class="h-right">
        <a href="" clas="">Start a new group - 30% off!</a>
