...
<head>
    ...
    <title>Your Account | Meetup</title>
            ...
            <div class="h-right collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ">
                    <li class="nav-item me-4 mt-1">
                        <a href="" class="text-decoration-none fw-light"><span style="letter-spacing: 0.5px;"
                                class="text-muted">Explore</span></a>
                    ...
                    <div class="sidebar m-0" style="width: 150px;">
                        <ul class="nav flex-column pe-2" style="letter-spacing: 0.65px;">
                            <li class="nav-item text-end list">
                                <a class="nav-link active" style="border-right: 4px solid #1f24cc;color:#1f24cc"
