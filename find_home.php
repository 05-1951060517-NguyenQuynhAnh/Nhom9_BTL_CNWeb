            ...
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                ...
                <div class="row col-md-12">
                    ...
                    <div class="col-md-9">
                        ...
                        <button class="border-0 bg-white"> <i class="bi bi-box-arrow-up"></i></button>
                        <button class="border-0 bg-white"><i class="bi bi-star"></i></button>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <hr class="mt-3">
                ...
                <div class="row col-md-12">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="mt-3">This is a group for individuals who have been victims of domestic violence.
                            Domestic violence affects an alarmingly large number...</div>
                        <div class="mt-3">208 member · Private <i class="bi bi-question-circle-fill"></i></div>
                ...
                <div class="row col-md-12">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="mt-3">Everyone welcome! Others probably consider you to be very capable, and you are. 
                            But have you ever felt that you could do...
                        </div>
                        <div class="mt-3">611 member · Public <i class="bi bi-question-circle-fill"></i></div>
                        <div class="d-flex justify-content-end">
                            <i class="bi bi-box-arrow-up"></i>
                        </div>
                    </div>
                ...
                <div class="row col-md-12">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="mt-3">Please read before you are planning to join the group!
                            Let's Explore the Nature! Most hikes will be in the Harriman State...
                        </div>
                        <div class="mt-3">1300 member · Public <i class="bi bi-question-circle-fill"></i></div>
                        <div class="d-flex justify-content-end">
                            <i class="bi bi-box-arrow-up"></i>
                        </div>
                    </div>
                ...
                <div class="row col-md-12">
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="mt-3">People who love soccer. Upper intermediate and advanced levels only. 
                            Please, no beginners. Indoors , 7x7 pickup soccer games.</div>
                        <div class="mt-3">179 member · Public <i class="bi bi-question-circle-fill"></i></div>
                        <div class="d-flex justify-content-end">
                            <i class="bi bi-box-arrow-up"></i>
                        </div>
                    </div>
