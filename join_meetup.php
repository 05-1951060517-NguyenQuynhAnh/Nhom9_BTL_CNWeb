...
<body>
    <main class="pt-5 px-5">
        ...
        <div class="container">
            <div class="row pt-5">
                <div class="col-md-6 ">
                    <svg class="mx-2 mt-5" viewBox="0 0 111 40" xmlns="http://www.w3.org/2000/svg" height="34px">
                        <path
                    ...
                    <h1 class="my_intro mr-3 mt-5">A world ofpossibilities on Meetup</h1>
                    <p class="my_intro mt-4">
                        Sign up for the Community Matters newsletter and get the latest updates on Meetup, as well as
                        tips for building community.

                        Subscribe + Join Meetup
                        By creating a Meetup account, you can drop into events happening across the world, every hour of
                        the day. Meet people, learn skills, and explore interests.



                        Meetup will share groups, events, and community-building tips to help you thrive. </p>
                        <form action="home.php">
                        <button class=" bg-danger border-0 hover" style="width:300px;height:50px;color:white"
                        type="submit">Subcribe + Join
                        Meetup</button>
                        </form>
